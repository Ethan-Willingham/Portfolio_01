/* ============================================================
   The Zhuangzi, a walk through the laughter.
   Approach B (the One-Reading Walk): the page is read top to
   bottom, so this script is light. It powers the sticky station
   rail: a scroll-spy that names the station you are in, a jump
   menu, and prev/next that scroll to the neighboring station.

   Contract with zhuangzi.html:
