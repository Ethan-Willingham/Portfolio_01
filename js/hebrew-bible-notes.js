/* ============================================================
   ...
   shape:  id: { title, gist, splits:[{he, translit, gloss, note}], read }
...
window.HB_NOTES = {
  ...
  "hillel": {
    ...
    read: "Notice Hillel gives the golden rule in the negative. Not <em>do unto others</em>, but <em>do not do</em> what you would hate. It asks for less and it is much harder to wriggle out of."
  },
  ...
  "gen-creation": {
    ...
    read: "Two ideas set the whole table: the world is an order pulled out of chaos, and the human is the one creature that carries God's stamp. Almost everything the prophets later demand is just those two facts, enforced."
  },
  ...
  "gen-lech-lecha": {
    ...
    read: "The founding act of the people is not a conquest or a miracle. It is one man told to leave home on the strength of a promise."
  },
  ...
  "akedah": {
    ...
    read: "Read on the Day of Judgment, not as a model to copy but as the limit case: how far does the covenant reach, and where does God himself call it off."
  },
  ...
  "burning-bush": {
    ...
    read: "The one place God names himself, the name turns out to be a verb in the future tense. He will be what he will be, and you find out by going."
  },
  ...
  "decalogue": {
    ...
    read: "The Jewish Ten open not with a rule but with a rescue. Obligation begins with <em>I am the one who brought you out</em>, not <em>thou shalt.</em>"
  },
  ...
  "holiness": {
    ...
    read: "The most quoted ethical line in Western history is a single verse in a chapter about farm wages and honest scales. That placement is the argument."
  },
  ...
  "shema": {
    ...
    read: "A tradition with very little required theology stakes its center right here, and even here the demand is not belief. It is attention (<em>hear</em>) and a love you act out."
  },
  ...
  "tzedek": {
    ...
    read: "Not justice you admire, or justice you wait for. Justice you chase. The verb does the work."
  },
  ...
  "choose-life": {
    ...
    read: "No heaven is offered here and no hell. Life and death are the stakes, this life, and the instruction could not be simpler. Pick the right one."
  },
  ...
  "isaiah-justice": {
    ...
    read: "The prophets are not fortune tellers. They are the conscience of the covenant, and the charge never changes: your worship is worthless if your courts are crooked."
  },
  ...
  "almah": {
    ...
    read: "This is the clearest case for why stacking translations matters. <em>Almah</em> or <em>virgin</em> is not a nuance. It is two religions, parting over one word."
  },
  ...
  "amos-justice": {
    ...
    read: "Through Amos, God says he would rather have no worship at all than worship from people who grind down the poor. The ritual is not the point. The justice is."
  },
  ...
  "micah": {
    ...
    read: "Centuries of theology, and a prophet from the sticks had already boiled the requirement down to eight words. Do justice, love kindness, walk humbly. The rest, as Hillel said, is commentary."
  },
  ...
  "psalm-23": {
    ...
    read: "Read the King James for the music, then read Alter to hear what the music covered. The psalm is not about a soul in the hereafter. It is about being kept alive right now."
  },
  ...
  "kohelet": {
    ...
    read: "And yet this book made the cut, and Jews read it on the harvest festival, the happy one. Its last word, after all the vapor, is to fear God and keep the commandments, because the doing is the part that is not breath."
  },
  ...
  "job-whirlwind": {
    ...
    read: "The tradition kept a whole book whose point is that the good suffer and God does not justify it. No tidy afterlife squares the ledger. That refusal to lie is exactly why it survived."
  }
