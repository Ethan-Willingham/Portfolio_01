/* The Modern Teachers: the five-teacher gallery.
...
(function () {
  ...
  var teachers = [].slice.call(source.querySelectorAll('.tale')).map(function (el) {
    return {
  ...
  function go(i) {
    cur = Math.max(0, Math.min(teachers.length - 1, i));
    render();
  }
