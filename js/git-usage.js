/* Usage charts for the git-history post. Static SVG, baked from ccusage
   ...
   (laptop + desktop) snapshot; May 22 to June 13 are this machine's ccusage
   (all agents on this machine, the game included), refreshed June 13. Renders
...
(function () {
  ...
  // combined tokens per day, May 1 to June 13 2026 (index 0 = May 1; May 15 and Jun 6 had no activity)
  ...
  // x labels
  [[0, 'May 1'], [9, '10'], [19, '20'], [30, '31'], [43, 'Jun 13']].forEach(function (t) {
