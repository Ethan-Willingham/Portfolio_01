/* Usage charts for the git-history post. Static SVG, baked from ccusage
   snapshots on two machines (laptop + desktop), May 2026. May 1-23 are the
   prior two-machine snapshot; May 24-27 were refreshed on May 27. No animation,
   no rAF — renders once. */
(function () {
  'use strict';
  ...
  var vals = [16607317, 36137104, 69177645, 42724566, 39884750, 410619, 81899196,
    ...
    1543803732, 1320336965, 702974597, 285643166, 43482793];
  ...
  var s = '<svg viewBox="0 0 ' + W + ' ' + H + '" preserveAspectRatio="xMidYMid meet" ' +
    ...
    'aria-label="Tokens burned per day in May 2026 through the 27th, peaking at 1.54 billion on the 23rd">';
  s += '<defs>' +
  ...
  // x labels
  [[0, 'May 1'], [4, '5'], [9, '10'], [14, '15'], [19, '20'], [23, '24'], [26, '27']].forEach(function (t) {
