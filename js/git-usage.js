/* Usage charts for the git-history post. Static SVG, baked from ccusage
   ...
   (laptop + desktop) snapshot; May 22 to June 12 are this machine's ccusage
   (all agents on this machine, the game included), refreshed June 11. Renders
   once (no rAF), then wires a hover readout. */
(function () {
  'use strict';
  var el = document.getElementById('gh-chart-daily');
  if (!el) return;

  // combined tokens per day, May 1 to June 12 2026 (index 0 = May 1; May 15 and Jun 6 had no activity)
  var vals = [16607317, 36137104, 69177645, 42724566, 39884750, 410619, 81899196,
    ...
    49406229, 0, 437292700, 97568887, 927412697, 737451722, 441003124, 59287147];
  ...
  // x labels
  [[0, 'May 1'], [9, '10'], [19, '20'], [30, '31'], [42, 'Jun 12']].forEach(function (t) {
