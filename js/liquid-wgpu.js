...
(function () {
  ...
  // v26.53.1 retains the requested 42 percent "fluid" landing rate:
  // 1.55 x (1 - 0.55 x 0.58³) = 1.383667. Wall-clock effective gravity
  // is about 479 px/s². Live via setSimParam('TIMESCALE') (gm
