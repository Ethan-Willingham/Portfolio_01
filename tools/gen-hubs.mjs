...
const HUBS = [
  {
    ...
    members: [
      ...
      live('analects.html', 'The Analects of Confucius, Side by Side', 'analects.jpg', 'c. 450 BCE', -450, "All 503 received passages in plain English, each followed by the original Chinese and every English translation in the corpus. Confucius on learning, ritual, government, friendship, grief, and the lifelong work of becoming decent."),
      ...
      live('zhuangzi.html', 'The Zhuangzi, the Book That Laughs', 'zhuangzi.jpg', 'c. 300 BCE', -300, "The other great Taoist classic, and the funny one. Wild little stories that puncture our certainty, like the man who dreams he is a butterfly and wakes unsure which he is, walked in Brook Ziporyn's translation."),
      live('dhammapada.html', 'The Dhammapada, Side by Side', 'dhammapada.jpg', 'c. 250 BCE', -250, "Buddhism's most loved little book, 423 verses of the Buddha's teaching in its plainest form: the mind makes the world, hatred is never ended by hatred, and the way out of suffering is to want less. Seven English translations side by side."),
      live('gita.html', 'The Bhagavad Gita: A Guided Reading', 'gita.jpg', 'c. 100 BCE', -100, "Hinduism's best-known scripture: a warrior loses his nerve on the edge of battle, and Krishna leads him from collapse back to chosen action. The whole conversation in plain English, twelve ideas living traditions practice, what history can establish, and the hard passages."),
      live('new-testament.html', 'The New Testament: A Guided Reading', 'new-testament.jpg', 'c. 70 CE', 70, "The Christian scriptures, opened as a small library: four distinct portraits of Jesus, the movement from Acts through Revelation, fifteen ideas living churches practice, what history can establish, and the passages that resist a clean summary."),
      ...
      live('quran.html', 'The Quran: A Guided Reading', 'quran.jpg', '632 CE', 632, "Islam's holy book, believed to be the literal words of God given to Muhammad in Arabic, which Muslims hold cannot truly be translated. Fourteen keystone passages in the Arabic against seven English versions, each only an interpretation of the meaning."),
