...
const HUBS = [
  ...
  },
  {
    ...
    members: [
      ...
      soon('Emmet Fox', '1934', "A 1934 reading of the Sermon on the Mount as practical mind-power, not a moral scolding. Passed hand to hand in early AA before its Big Book existed, and a root of its idea of a God you understand for yourself."),
      ...
      soon('When a Path Becomes a Cage', 'modern', "How a search for meaning hardens into a cult: first the thought-reform playbook, then the cases, from Scientology to Jonestown. A clearly labeled case study, not an endorsement."),
      soon('When a Path Becomes a Business', 'modern', "The other failure mode, spirituality with a price tag: est and Landmark, A Course in Miracles, the prosperity gospel, and the line where teaching ends and selling begins."),
    ],
  },
  {
