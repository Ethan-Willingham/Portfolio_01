...
| Lever | Now | Effect |
|---|---|---|
| `LIQUID_RAW` | `1` | v24.169 — run saharan's model: the RAW branch at the top of `liquidStateTick` forces damp/motion=1, visc=0, no sleep/freeze/brake. THE liveliness baseline; 0 = the old masking stack |
