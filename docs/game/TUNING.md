...
| `LIQUID_SURF_BRIDGE_R` `edit²` | `3` | 1–8 | v26.57 tap radius in device px for the bridge. Larger closes wider tears but rounds the silhouette more. gm `water.SURF_BRIDGE_R` |
